 ...
 */
class CreateSignatureKeyResponse implements JsonSerializable
{
    /**
     ...
     * @param string $publicKey Initialization value for $this->publicKey
    ...
    public function __construct()
    {
        if (6 == func_num_args()) {
            ...
            $this->cipher    = func_get_arg(2);
            $this->digest    = func_get_arg(3);
            $this->created   = func_get_arg(4);
            $this->enabled   = func_get_arg(5);
        }
    }
