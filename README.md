...
```php
function updateEnableSignatureKey($body)
```
...
### <a name="get_signature_key_list"></a>![Method: ](https://apidocs.io/img/method.png ".SignatureKeyManagementController.getSignatureKeyList") getSignatureKeyList
...
```php
function deleteSignatureKey($keyId)
```
...
### <a name="get_signature_key_detail"></a>![Method: ](https://apidocs.io/img/method.png ".SignatureKeyManagementController.getSignatureKeyDetail") getSignatureKeyDetail
...
```php
function getSignatureKeyDetail($keyId)
```
...
```php
function createSignatureKey($body)
```
...
```php
$bodyValue = "{   \"digest\": \"SHA224\",   \"cipher\": \"RSA\" }";
